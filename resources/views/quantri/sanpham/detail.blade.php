...
@section('title','Manager ! Chi Tiết Sản Phẩm')
@section('tit','Chi Tiết Sản Phẩm')
@section('content')
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" name="masp" class="form-control" value="{{ $item['masp'] }}" required placeholder="Input field">
